window.onload = function () {
  setTimeout(function(){
    document.getElementById("searchbar-div").style.top = 48 + offset + "px"; // Set the top of the Filters dropdown to the bottom of the Searchbar div (the element that goes above it).
    ...
    document.getElementById("filters-options").style.top = 93 + offset + "px"; // Set the top of the Filters dropdown to the bottom of the Searchbar div (the element that goes above it).
